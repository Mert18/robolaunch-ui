 ...
 * @final
 */
proto.launch.LaunchClient = function (hostname, credentials, options) {
  if (!options) options = {};
  options.format = "text";
 ...
 * @final
 */
proto.launch.LaunchPromiseClient = function (hostname, credentials, options) {
  if (!options) options = {};
  options.format = "text";
 ...
 */
proto.launch.LaunchClient.prototype.listLaunch = function (request, metadata) {
  return this.client_.serverStreaming(
    this.hostname_ + "/launch.Launch/ListLaunch",
    request,
    metadata || {},
 ...
 *     The XHR Node Readable Stream
 */
proto.launch.LaunchPromiseClient.prototype.listLaunch = function (
  request,
  metadata
) {
  return this.client_.serverStreaming(
 ...
 *     The XHR Node Readable Stream
 */
proto.launch.LaunchClient.prototype.createLaunch = function (
  request,
  metadata,
  callback
) {
  return this.client_.rpcCall(
    this.hostname_ + "/launch.Launch/CreateLaunch",
    request,
    metadata || {},
 ...
 */
proto.launch.LaunchPromiseClient.prototype.createLaunch = function (
  request,
  metadata
) {
 ...
 *     The XHR Node Readable Stream
 */
proto.launch.LaunchClient.prototype.operateLaunch = function (
  request,
  metadata,
  callback
) {
  return this.client_.rpcCall(
    this.hostname_ + "/launch.Launch/OperateLaunch",
    request,
    metadata || {},
 ...
 *     Promise that resolves to the response
 */
proto.launch.LaunchPromiseClient.prototype.operateLaunch = function (
  request,
  metadata
) {
  return this.client_.unaryCall(
 ...
 *     The XHR Node Readable Stream
 */
proto.launch.LaunchClient.prototype.getLaunch = function (
  request,
  metadata,
  callback
) {
  return this.client_.rpcCall(
    this.hostname_ + "/launch.Launch/GetLaunch",
    request,
    metadata || {},
 ...
 *     Promise that resolves to the response
 */
proto.launch.LaunchPromiseClient.prototype.getLaunch = function (
  request,
  metadata
) {
  return this.client_.unaryCall(
